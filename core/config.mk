...
ifneq ($(GENESIS_BUILD),)
include vendor/genesis/config/BoardConfigGenesis.mk
endif
...
ifneq ($(GENESIS_BUILD),)
ifneq ($(wildcard device/genesis/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/genesis/sepolicy/common/sepolicy.mk)
endif
endif
